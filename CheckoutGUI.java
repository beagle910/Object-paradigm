...
//    private String lnames[]={"Name", "Price", "Weight", "Price/lbs", "Price/doz", "Number"};
	private String lnames[] = { "Name", "Price", "Weight", "Price/lbs", "Price/doz", "Number", "Topping",
			"Topping Cost" };
		...
		} else if (source == buttons2[0]) // Enter
		{
			...
			try {
				...
				case 0: // Ice Cream
					...
					break;
				case 1: // Candy
					checkout.enterItem(new Candy(tfields[0].getText(), Double.parseDouble(tfields[2].getText()),
				...
				case 2: // Baked Goods
					...
					break;
				case 3: // Sundae
					checkout.enterItem(new Sundae(tfields[0].getText(),
//							Integer.parseInt(tfields[5].getText()),
							Integer.parseInt(tfields[1].getText()), tfields[6].getText(),
